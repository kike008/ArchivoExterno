package com.example.kike.archivoexterno;
            ...
            if (Environment.getExternalStorageState().equals("mounted")){
                ...
                if (v.equals(btnGuardar)) {
                    ...
                    try {
                        ...
                        // directorio
                        // la memoria externa
                        directory = new File(sdCard.getAbsolutePath() + "/documents");
                        ...
                        Toast.makeText(getBaseContext(), "El archivo se ha guardado!!!", Toast.LENGTH_SHORT).show();
                        txtTexto.setText("");
                ...
                if (v.equals(btnAbrir)) {
                    try {
                        ...
                        Toast.makeText(getBaseContext(), "El archivo se cargo", Toast.LENGTH_SHORT).show();
                        } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
            }else {
                Toast.makeText(getBaseContext(), "El almacenamiento interno no se encuestra", Toast.LENGTH_LONG).show();
            }
